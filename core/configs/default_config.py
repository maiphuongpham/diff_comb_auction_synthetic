...
__C.net.activation = "tanh"#"tanh" #"tanh" # original tanh
...
__C.train.rgt_target_start = 0.05
__C.train.rgt_target_end = 0.0005 #0.0008 for others, 0.0005 for 01
__C.train.rgt_lr = 0.01
__C.train.rgt_ratio = 1
__C.train.ic_weight = 0.1
...
__C.train.tau_start = 100
__C.train.tau_end = 1#0.01

# Whether to use CC2 incident matrix
__C.cc2 = False
__C.val_model = False

# Whether to use airport case
__C.airport_case = False
